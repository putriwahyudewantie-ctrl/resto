                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <span class="badge bg-warning text-dark p-2 d-block w-100 shadow-sm mb-2"><i class="fa fa-exclamation-circle"></i>Belum Bayar DP</span>
                                ...
                                <span class="badge bg-info text-white p-2 d-block w-100 shadow-sm">Cooking</span>

                                @elseif($booking->status == 'Ready')
                                <span class="badge bg-success text-white p-2 d-block w-100 shadow-sm">Ready</span>
                                @else
