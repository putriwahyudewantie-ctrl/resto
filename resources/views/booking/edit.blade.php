            ...
            <div class="mb-4 mt-4">
                ...
                <div class="row g-3" style="max-height: 500px; overflow-y: auto; overflow-x: hidden; padding: 10px; background: #f8fafc; border-radius:18px; border: 1px solid #e2e8f0;">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="card h-100 border-0 shadow-sm" id="menu_card_{{ $menu->id }}" 
                            @style([
                                'position: relative',
                                'border-radius:14px',
                                'transition: all 0.2s ease',
                                'overflow:hidden',
                                'background: #f0f7ff; box-shadow: 0 10px 20px rgba(0,0,0,0.1) !important; transform: translateY(-4px)' => $oldQty > 0,
                                'background: #fff' => !($oldQty > 0)
                            ])>
