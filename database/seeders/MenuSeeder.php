...
class MenuSeeder extends Seeder
{
    ...
    ['nama_menu' => 'Nasi Nila Goreng', 'kategori' => 'Nasi', 'harga' => 22000, 'deskripsi' => 'Ikan nila yang digoreng garing hingga renyah di luar namun tetap lembut di dalam.', 'gambar' => 'nasi_ikan_nila_goreng.jpeg'],
    
    // SEAFOOD
    ['nama_menu' => 'Kepiting Saus Padang', 'kategori' => 'Seafood', 'harga' => 85000, 'deskripsi' => 'Kepiting utuh segar yang dimasak bumbu padang super pedas.', 'gambar' => 'kepiting saos.jpeg'],
    ['nama_menu' => 'Udang Bakar Madu', 'kategori' => 'Seafood', 'harga' => 45000, 'deskripsi' => 'Sate udang ukuran besar dengan baluran saus madu manis.', 'gambar' => 'udang bakar madu.jpeg'],
    ['nama_menu' => 'Cumi Goreng Tepung', 'kategori' => 'Seafood', 'harga' => 35000, 'deskripsi' => 'Cincin cumi yang digoreng krispi dengan cocolan saus tartar.', 'gambar' => 'cumi goreng tepung.jpeg'],
    ['nama_menu' => 'Kerang Hijau Saus Tiram', 'kategori' => 'Seafood', 'harga' => 30000, 'deskripsi' => 'Sajian kerang hijau basah dengan bumbu tiram gurih manis.', 'gambar' => 'kerang ijo saos tiram.jpeg'],
    ['nama_menu' => 'Gurame Asam Manis', 'kategori' => 'Seafood', 'harga' => 65000, 'deskripsi' => 'Ikan gurame filet goreng renyah disiram saus nanas asam manis.', 'gambar' => 'gurame asam manis.jpeg'],
    ...
    ['nama_menu' => 'Pisang Bakar Coklat Keju', 'kategori' => 'Snack', 'harga' => 18000, 'deskripsi' => 'Pisang kepok panggang dengan limpahan topping meses dan keju Cheddar.', 'gambar' => 'pisang bakar keju coklat.jpeg'],
    ['nama_menu' => 'Lumpia Kulit Tahu', 'kategori' => 'Snack', 'harga' => 20000, 'deskripsi' => 'Olahan ikan cincang dibalut kulit tahu krispi khas Chinese food.', 'gambar' => 'limpia kulit tahu.jpeg'],
    ['nama_menu' => 'Roti Bakar Kaya', 'kategori' => 'Snack', 'harga' => 18000, 'deskripsi' => 'Roti panggang tradisional dengan olesan selai srikaya legit dan mentega lapis.', 'gambar' => 'roti bkaar.jpeg'],
    ['nama_menu' => 'Tahu Crispy Cabai Garam', 'kategori' => 'Snack', 'harga' => 15000, 'deskripsi' => 'Potongan tahu goreng tepung garing dengan taburan rempah cabai bawang gurih pedas.', 'gambar' => 'tahu cabai garam.jpeg'],
    // MINUMAN (Tambahan 6 menu buat total 36)
    ['nama_menu' => 'Es Teh Manis', 'kategori' => 'Minuman', 'harga' => 5000, 'deskripsi' => 'Teh melati manis khas rumahan yang disajikan dengan es batu segar dingin.', 'gambar' => 'es teh manis.jpeg'],
    ['nama_menu' => 'Es Jeruk', 'kategori' => 'Minuman', 'harga' => 7000, 'deskripsi' => 'Perasan jeruk peras asli manis segar, kaya akan vitamin C.', 'gambar' => 'es jeruk.jpeg'],
    ['nama_menu' => 'Kopi Hitam', 'kategori' => 'Minuman', 'harga' => 8000, 'deskripsi' => 'Kopi tubruk murni khas warkop, diseduh panas pekat memanggil kantuk untuk pergi.', 'gambar' => 'kopi hitam.jpeg'],
    ['nama_menu' => 'Teh Tarik', 'kategori' => 'Minuman', 'harga' => 12000, 'deskripsi' => 'Campuran teh dan susu kental manis, ditarik berulang hingga berbusa tebal lembut.', 'gambar' => 'teh tarik.jpeg'],
    ['nama_menu' => 'Jus Alpukat', 'kategori' => 'Minuman', 'harga' => 15000, 'deskripsi' => 'Jus alpukat mentega segar dengan kental manis cokelat di dinding gelas keramik.', 'gambar' => 'jus alpukat.jpeg'],
    ['nama_menu' => 'Soda Gembira', 'kategori' => 'Minuman', 'harga' => 14000, 'deskripsi' => 'Paduan sirup frambozen klasik dengan susu dan air soda yang meletup-letup ceria.', 'gambar' => 'soda gembira.jpeg'],
        ];
